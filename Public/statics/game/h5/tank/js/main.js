...
function canvasApp() {
	...
	tank.src="/Public/statics/game/h5/tank/tanks_sheet.png"
	//Background
	...
	explodeSound.setAttribute("src", "/Public/statics/game/h5/tank/explode1.mp3");
	explodeSound.valume=.5;
	//发射子弹
	var shootSound = document.createElement("audio");
	document.body.appendChild(shootSound);
	shootSound.setAttribute("src", "/Public/statics/game/h5/tank/shoot1.mp3");
	shootSound.volume=.5;
	//玩家行走
	var playermove = document.createElement("audio");
	document.body.appendChild(playermove);
	playermove.setAttribute("src", "/Public/statics/game/h5/tank/move1.mp3");
	playermove.valume=.001;
	//敌人行走
	var enemyrmove = document.createElement("audio");
	document.body.appendChild(enemyrmove);
	enemyrmove.setAttribute("src", "/Public/statics/game/h5/tank/move2.mp3");
