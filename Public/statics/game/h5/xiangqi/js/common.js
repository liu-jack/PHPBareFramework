...
window.onload = function(){  
	...
	com.getData("/Public/statics/game/h5/xiangqi/js/gambit.all.js",
		function(data){
		com.gambit=data.split(" ");
		AI.historyBill = com.gambit;
	})
	com.getData("/Public/statics/game/h5/xiangqi/js/store.js",
		function(data){
...
com.loadImages = function(stype){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = "/Public/statics/game/h5/xiangqi/img/"+stype+"/bg.png";
	
	//提示点
	com.dotImg = new Image();
	com.dotImg.src  = "/Public/statics/game/h5/xiangqi/img/"+stype+"/dot.png";
	
	//棋子
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "/Public/statics/game/h5/xiangqi/img/"+stype+"/"+ com.args[i].img +".png";
	}
	
	//棋子外框
	com.paneImg = new Image();
	com.paneImg.src  = "/Public/statics/game/h5/xiangqi/img/"+stype+"/r_box.png";
