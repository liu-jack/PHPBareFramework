 ...
 function firstinit() {
  ...
  imgpreload(new Array('/Public/statics/game/h5/wood/i/dropshadow.png','/Public/statics/game/h5/wood/i/11.png','/Public/statics/game/h5/wood/i/12.png','/Public/statics/game/h5/wood/i/13.png','/Public/statics/game/h5/wood/i/21.png','/Public/statics/game/h5/wood/i/22.png','/Public/statics/game/h5/wood/i/23.png','/Public/statics/game/h5/wood/i/31.png','/Public/statics/game/h5/wood/i/32.png','/Public/statics/game/h5/wood/i/33.png','/Public/statics/game/h5/wood/i/41.png','i/42.png','/Public/statics/game/h5/wood/i/43.png'));
  document.body.addEventListener("touchmove", function(e) {
          e.preventDefault();
  }, false);
 }
 ...
 function init() {
  ...
  tmp.style.backgroundImage='url(/Public/statics/game/h5/wood/i/stackthelog.png)';
...
tmp.style.padding='17px 11px 0 11px';
  ...
  tmp.style.backgroundImage='url(/Public/statics/game/h5/wood/i/bg1250.png)';
  ...
  tmp=document.createElement('div');
  tmp.style.backgroundImage='url(/Public/statics/game/h5/wood/i/fuhatul.png)';
  tmp.style.position='absolute';
  tmp.style.width='320px';
  ...
  tmp=document.createElement('div');
  tmp.style.backgroundImage='url(/Public/statics/game/h5/wood/i/fuelol.png)';
  tmp.style.position='absolute';
...
function addshadow() {
  ...
  tmp.src='/Public/statics/game/h5/wood/i/dropshadow.png';
  tmp.id='shd_'+sts;
  tmp.style.zIndex='15';
  tmp.style.position='absolute';
  tmp.style.width=(extraleft[sttype[sts]]+stwidth[sts]+extraright/2)+'px';
...
function showaronk(srid,srtype,srstart,srsize) {
 srt='/Public/statics/game/h5/wood/i/'+srtype
 tmp=document.createElement('div');
 tmp.style.position='absolute';
