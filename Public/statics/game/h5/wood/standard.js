...
//  }
 ...
 function imgpreload(ims) {
  myims=new Array();
  ims.push('/Public/statics/game/h5/wood/i/b_yes.png');
  ims.push('/Public/statics/game/h5/wood/i/b_no.png');
  ims.push('/Public/statics/game/h5/wood/i/b_okay.png');
  for(i in ims) {
   myims[i]=new Image();
   myims[i].src=ims[i];
  }
  ...
  function ialert(iquestion,idoit) {
   document.getElementById('alertbox_content').innerHTML=iquestion+'<br style="clear:both" /><br /><a href="#" onclick="idismiss();eval(\''+idoit+'\'); return false;" ontouchstart="idismiss();eval(\''+idoit+'\'); return false;"><img src="/Public/statics/game/h5/wood/i/b_okay.png" alt="确定" /></a>';
   document.getElementById('alertbox').style.display='block';
  }
    
  function iconfirm(iquestion,idoit) {
   document.getElementById('alertbox_content').innerHTML=iquestion+'<br style="clear:both" /><br /><a href="#" ontouchstart="idismiss();eval(\''+idoit+'\'); return false;" onclick="idismiss();eval(\''+idoit+'\'); return false;"><img src="/Public/statics/game/h5/wood/i/b_yes.png" alt="Yes" /></a><a href="#" ontouchstart="idismiss(); return false;" onclick="idismiss(); return false;"><img src="/Public/statics/game/h5/wood/i/b_no.png" alt="No" /></a>';
   document.getElementById('alertbox').style.display='block';
  }
 ...
 function setCookie(name, value) {
  document.cookie = name + "=" + escape(value) + ((expire == null) ? "" : ("; expires=" + expire.toGMTString())+';domain=;path=/;');
 }
